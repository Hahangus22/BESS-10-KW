...
#elif defined(ESP32)	
	#define ADC_MAX 1023  // maximum value for ESP32 ADC (configured to 10 bits in main.cpp)
	#define aXM 15  // analog input pin connected to LCD_RS 
	#define aYP 4  // analog input pin connected to LCD_WR
#else
#undef ESP32_WIFI_TOUCH
